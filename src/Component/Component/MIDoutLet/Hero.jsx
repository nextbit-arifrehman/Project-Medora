...
const Hero = () => {
  ...
  <div className='flex flex-col items-center text-center'>
    ...
    <p className='font-medium lg:py-4'>
      ...
      <span className='block'>Whether it's a routine checkup or urgent consultation, book appointments in minutes and receive quality care you can trust.</span>
    </p>

    <form className="flex flex-col md:flex-row justify-center items-center w-full max-w-3xl mx-auto space-y-2 md:space-y-0 md:space-x-2 mb-6 px-3">
      <input
        type="text"
        placeholder="Search any Doctor"
        className="bg-white border border-gray-300 rounded-2xl shadow-md w-full md:w-2/3 px-4 py-2"
      />
      <button className="bg-[#176AE5] rounded-2xl px-4 py-2 text-white font-semibold shadow-md cursor-pointer">
        Search Now
      </button>
    </form>
  </div>
